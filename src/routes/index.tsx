  ...
  const packages = [
    {
      emoji: '🟢',
      name: 'Smart Start',
      tagline: 'Know Your Boat at All Times',
      price: 'Contact for pricing',
      tier: 'entry',
      color: '#10b981',
      features: [
        'Remote monitoring (battery, bilge, temp)',
        'Mobile push alerts',
    ...
    },
    {
      emoji: '🔵',
      name: 'Smart Control',
      tagline: 'Control Your Boat From Anywhere',
      price: 'Contact for pricing',
      tier: 'mid',
      color: '#0ea5e9',
      features: [
    ...
    },
    {
      ...
      tagline: 'Your Boat Thinks Ahead for You',
      price: 'Contact for pricing',
      tier: 'premium',
      color: '#f59e0b',
      features: [
        'Everything in Smart Control',
        'Predictive maintenance engine',
        'AI diagnostics & anomaly detection',
        'Fuel efficiency insights',
        'Weather & navigation intelligence',
